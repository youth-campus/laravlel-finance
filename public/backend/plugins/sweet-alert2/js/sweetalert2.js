!(function (t, e) {
    ...
    function at(t, e) {
        ...
        e.showConfirmButton || e.showCancelButton || G(n),
            ...
            e.buttonsStyling
                ...
                : (ut([o, i], z.styled), (o.style.backgroundColor = o.style.borderLeftColor = o.style.borderRightColor = ""), (i.style.backgroundColor = i.style.borderLeftColor = i.style.borderRightColor = "")),
    ...
    (Pt.text = Pt.email = Pt.password = Pt.number = Pt.tel = Pt.url = function (t, e) {
        return (
            "string" == typeof e.inputValue || "number" == typeof e.inputValue ? (t.value = e.inputValue) : v(e.inputValue) || D('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(r(e.inputValue), '"')),
            bt(t, e),
            (t.type = e.input),
            t
        );
    ...
    var Mt = function () {
        ...
        qt = function (t, e) {
            (t.className = "".concat(z.popup, " ").concat(dt(t) ? e.showClass.popup : "")),
                e.toast ? (st([document.documentElement, document.body], z["toast-shown"]), st(t, z.toast)) : st(t, z.modal),
                R(t, e, "popup"),
    ...
    function ne(t, e, n, o) {
        n
            ...
            : (Nt().then(function () {
              ...
              zt.keydownTarget.removeEventListener("keydown", zt.keydownHandler, { capture: zt.keydownListenerCapture }),
    ...
    var Ce = function (e, n) {
        ...
        Ee = function (e, n) {
            ...
            v(n.inputOptions)
                ...
                ? o(n.inputOptions)
                : h("Unexpected type of inputOptions! Expected object, Map or Promise, got ".concat(r(n.inputOptions)));
        },
        Se = function (e, n) {
            var o = e.getInput();
            G(o),
        ...
        Qe = Object.freeze({
            ...
            _main: function (t) {
                !(function (t) {
                    ...
                    C() && zt.swalCloseEventFinishedCallback && (zt.swalCloseEventFinishedCallback(), delete zt.swalCloseEventFinishedCallback),
                ...
                var n = (function (t) {
                    var e = { popup: C(), container: y(), content: A(), actions: L(), confirmButton: S(), cancelButton: T(), closeButton: j(), validationMessage: E(), progressSteps: B() };
